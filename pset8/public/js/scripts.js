...
function addMarker(place)
{
    ...
    /*var marker = new google.maps.Marker ({
        ...
        title: place.place_name + " News",       
    });
    */
    
    //create marker of place with label
    var marker = new MarkerWithLabel ({
        ...
        title: "click for the " + place.place_name + " News"      
    });
    
    //insert marker of place in the global markers array
        ...
        .done(function(data, textStatus, jqXHR) {                    
            if (data.length > 0){         
                ...
                for (var i = 0; i < data.length; i++) {    
                    //https://cs50.stackexchange.com/questions/14683/pset8-mashup-getjson-for-articles-php-not-working
                    //was really helpful
                ...
                var noNews = "no news here today!";
                showInfo(marker, noNews);
            }               
        })
...
{
    //iterate over the global markers array to remove them 
    for (var i = 0; i < markers.length; i++) {
